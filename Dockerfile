...
CMD nodeos --data-dir $EOSDIR  --config-dir  $EOSDIR --genesis $EOSDIR --http-server-address=0.0.0.0:8888 --access-control-allow-origin=* --contracts-console --http-validate-host=false